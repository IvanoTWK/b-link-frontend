...
const NAV_ITEMS = [
  { href: "/donors", label: "Dashboard", icon: LayoutDashboard, exact: true },
  { href: "/donors/bookings", label: "Prenotazioni", icon: CalendarDays, exact: false },
  { href: "/donors/donations", label: "Donazioni", icon: Droplets, exact: false },
  { href: "/donors/profile", label: "Profilo", icon: User, exact: false },
]
